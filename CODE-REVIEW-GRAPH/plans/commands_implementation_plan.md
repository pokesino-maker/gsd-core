# Plan de Mapeo Exhaustivo de Optimizaciones con Code-Review-Graph (Solo Comandos)

Analizar uno por uno todos los comandos (en `commands/gsd/`) en busca de lógicas y comandos ineficientes (tipo `read`, `bash`, `glob`, `grep`) y registrar en `CODE-REVIEW-GRAPH/commands_mapping.json` su traducción exacta y optimizada para el uso del servidor MCP local `code-review-graph`.
...
A continuación se detalla la relación de correspondencia entre los comandos de `grep` utilizados en los comandos de GSD-Core y las herramientas específicas de `code-review-graph`:
...
A continuación se detalla la relación de correspondencia para los patrones de `glob` y búsquedas de archivos en los comandos de GSD-Core que pueden ser suplidos eficientemente por las herramientas de CRG:
...
A continuación se detalla la relación de correspondencia para las operaciones de lectura de archivos (`read`, `cat`, `view_file`) que pueden ser delegadas a CRG para optimizar el consumo de tokens en los comandos:
...
## Listado Completo de Comandos Analizados

Se ha realizado el listado en estricto orden alfabético de los 67 comandos de la carpeta `commands/gsd/`:

1.  `commands/gsd/add-tests.md` [ ] - Pendiente de análisis.
2.  `commands/gsd/ai-integration-phase.md` [ ] - Pendiente de análisis.
3.  `commands/gsd/audit-fix.md` [ ] - Pendiente de análisis.
4.  `commands/gsd/audit-milestone.md` [ ] - Pendiente de análisis.
5.  `commands/gsd/audit-uat.md` [ ] - Pendiente de análisis.
6.  `commands/gsd/autonomous.md` [ ] - Pendiente de análisis.
7.  `commands/gsd/capture.md` [ ] - Pendiente de análisis.
8.  `commands/gsd/cleanup.md` [ ] - Pendiente de análisis.
9.  `commands/gsd/code-review.md` [ ] - Pendiente de análisis.
10. `commands/gsd/complete-milestone.md` [ ] - Pendiente de análisis.
11. `commands/gsd/config.md` [ ] - Pendiente de análisis.
12. `commands/gsd/debug.md` [ ] - Pendiente de análisis.
13. `commands/gsd/discuss-phase.md` [ ] - Pendiente de análisis.
14. `commands/gsd/docs-update.md` [ ] - Pendiente de análisis.
15. `commands/gsd/eval-review.md` [ ] - Pendiente de análisis.
16. `commands/gsd/execute-phase.md` [ ] - Pendiente de análisis.
17. `commands/gsd/explore.md` [ ] - Pendiente de análisis.
18. `commands/gsd/extract-learnings.md` [ ] - Pendiente de análisis.
19. `commands/gsd/fast.md` [ ] - Pendiente de análisis.
20. `commands/gsd/forensics.md` [ ] - Pendiente de análisis.
21. `commands/gsd/graphify.md` [ ] - Pendiente de análisis.
22. `commands/gsd/health.md` [ ] - Pendiente de análisis.
23. `commands/gsd/help.md` [ ] - Pendiente de análisis.
24. `commands/gsd/import.md` [ ] - Pendiente de análisis.
25. `commands/gsd/inbox.md` [ ] - Pendiente de análisis.
26. `commands/gsd/ingest-docs.md` [ ] - Pendiente de análisis.
27. `commands/gsd/manager.md` [ ] - Pendiente de análisis.
28. `commands/gsd/map-codebase.md` [ ] - Pendiente de análisis.
29. `commands/gsd/milestone-summary.md` [ ] - Pendiente de análisis.
30. `commands/gsd/mvp-phase.md` [ ] - Pendiente de análisis.
31. `commands/gsd/new-milestone.md` [ ] - Pendiente de análisis.
32. `commands/gsd/new-project.md` [ ] - Pendiente de análisis.
33. `commands/gsd/ns-context.md` [ ] - Pendiente de análisis.
34. `commands/gsd/ns-ideate.md` [ ] - Pendiente de análisis.
35. `commands/gsd/ns-manage.md` [ ] - Pendiente de análisis.
36. `commands/gsd/ns-project.md` [ ] - Pendiente de análisis.
37. `commands/gsd/ns-review.md` [ ] - Pendiente de análisis.
38. `commands/gsd/ns-workflow.md` [ ] - Pendiente de análisis.
39. `commands/gsd/pause-work.md` [ ] - Pendiente de análisis.
40. `commands/gsd/phase.md` [ ] - Pendiente de análisis.
41. `commands/gsd/plan-phase.md` [ ] - Pendiente de análisis.
42. `commands/gsd/plan-review-convergence.md` [ ] - Pendiente de análisis.
43. `commands/gsd/pr-branch.md` [ ] - Pendiente de análisis.
44. `commands/gsd/profile-user.md` [ ] - Pendiente de análisis.
45. `commands/gsd/progress.md` [ ] - Pendiente de análisis.
46. `commands/gsd/quick.md` [ ] - Pendiente de análisis.
47. `commands/gsd/resume-work.md` [ ] - Pendiente de análisis.
48. `commands/gsd/review-backlog.md` [ ] - Pendiente de análisis.
49. `commands/gsd/review.md` [ ] - Pendiente de análisis.
50. `commands/gsd/secure-phase.md` [ ] - Pendiente de análisis.
51. `commands/gsd/settings.md` [ ] - Pendiente de análisis.
52. `commands/gsd/ship.md` [ ] - Pendiente de análisis.
53. `commands/gsd/sketch.md` [ ] - Pendiente de análisis.
54. `commands/gsd/spec-phase.md` [ ] - Pendiente de análisis.
55. `commands/gsd/spike.md` [ ] - Pendiente de análisis.
56. `commands/gsd/stats.md` [ ] - Pendiente de análisis.
57. `commands/gsd/surface.md` [ ] - Pendiente de análisis.
58. `commands/gsd/thread.md` [ ] - Pendiente de análisis.
59. `commands/gsd/ui-phase.md` [ ] - Pendiente de análisis.
60. `commands/gsd/ui-review.md` [ ] - Pendiente de análisis.
61. `commands/gsd/ultraplan-phase.md` [ ] - Pendiente de análisis.
62. `commands/gsd/undo.md` [ ] - Pendiente de análisis.
63. `commands/gsd/update.md` [ ] - Pendiente de análisis.
64. `commands/gsd/validate-phase.md` [ ] - Pendiente de análisis.
65. `commands/gsd/verify-work.md` [ ] - Pendiente de análisis.
66. `commands/gsd/workspace.md` [ ] - Pendiente de análisis.
67. `commands/gsd/workstreams.md` [ ] - Pendiente de análisis.
...
* Escaneo secuencial en estricto orden alfabético de los comandos de la carpeta `commands/gsd/` en busca de lógicas y comandos ineficientes de terminal (tipo `grep`, `glob`, `find`, `read`, etc.).

### Fase 2: Escritura y Validación
* Generación de `CODE-REVIEW-GRAPH/commands_mapping.json`.
...
### Verificación Manual
* Validar la validez de `commands_mapping.json` mediante un parser de JSON.
* Asegurar que cada `line_range` y `original_text` mapeado se corresponda exactamente con los archivos del repositorio en Git.
