# Plan de Mapeo Exhaustivo de Optimizaciones con Code-Review-Graph (Solo Plantillas)

Analizar uno por uno todos los archivos de plantilla (en `gsd-core/templates/`) en busca de lógicas y comandos ineficientes (tipo `read`, `bash`, `glob`, `grep`) y registrar en `CODE-REVIEW-GRAPH/templates_mapping.json` su traducción exacta y optimizada para el uso del servidor MCP local `code-review-graph`.
...
A continuación se detalla la lista exacta de las 30 herramientas MCP disponibles en `code-review-graph` para que puedas mapear la lógica de las plantillas a las herramientas correctas:
...
A continuación se detalla la relación de correspondencia entre los comandos de `grep` utilizados en las plantillas de GSD-Core y las herramientas específicas de `code-review-graph`:
...
A continuación se detalla la relación de correspondencia para los patrones de `glob` y búsquedas de archivos en las plantillas de GSD-Core que pueden ser suplidos eficientemente por las herramientas de CRG:
...
A continuación se detalla la relación de correspondencia para las operaciones de lectura de archivos (`read`, `cat`, `view_file`) que pueden ser delegadas a CRG para optimizar el consumo de tokens en las plantillas:
...
## Listado Completo de Plantillas Analizadas

Se ha realizado el listado en estricto orden alfabético de los 45 archivos markdown de la carpeta `gsd-core/templates/`:

1.  `gsd-core/templates/AI-SPEC.md` [ ] - Pendiente de análisis.
2.  `gsd-core/templates/DEBUG.md` [ ] - Pendiente de análisis.
3.  `gsd-core/templates/README.md` [ ] - Pendiente de análisis.
4.  `gsd-core/templates/SECURITY.md` [ ] - Pendiente de análisis.
5.  `gsd-core/templates/UAT.md` [ ] - Pendiente de análisis.
6.  `gsd-core/templates/UI-SPEC.md` [ ] - Pendiente de análisis.
7.  `gsd-core/templates/VALIDATION.md` [ ] - Pendiente de análisis.
8.  `gsd-core/templates/claude-md.md` [ ] - Pendiente de análisis.
9.  `gsd-core/templates/codebase/architecture.md` [ ] - Pendiente de análisis.
10. `gsd-core/templates/codebase/concerns.md` [ ] - Pendiente de análisis.
11. `gsd-core/templates/codebase/conventions.md` [ ] - Pendiente de análisis.
12. `gsd-core/templates/codebase/integrations.md` [ ] - Pendiente de análisis.
13. `gsd-core/templates/codebase/stack.md` [ ] - Pendiente de análisis.
14. `gsd-core/templates/codebase/structure.md` [ ] - Pendiente de análisis.
15. `gsd-core/templates/codebase/testing.md` [ ] - Pendiente de análisis.
16. `gsd-core/templates/context.md` [ ] - Pendiente de análisis.
17. `gsd-core/templates/continue-here.md` [ ] - Pendiente de análisis.
18. `gsd-core/templates/copilot-instructions.md` [ ] - Pendiente de análisis.
19. `gsd-core/templates/debug-subagent-prompt.md` [ ] - Pendiente de análisis.
20. `gsd-core/templates/dev-preferences.md` [ ] - Pendiente de análisis.
21. `gsd-core/templates/discovery.md` [ ] - Pendiente de análisis.
22. `gsd-core/templates/discussion-log.md` [ ] - Pendiente de análisis.
23. `gsd-core/templates/milestone-archive.md` [ ] - Pendiente de análisis.
24. `gsd-core/templates/milestone.md` [ ] - Pendiente de análisis.
25. `gsd-core/templates/phase-prompt.md` [ ] - Pendiente de análisis.
26. `gsd-core/templates/planner-subagent-prompt.md` [ ] - Pendiente de análisis.
27. `gsd-core/templates/project.md` [ ] - Pendiente de análisis.
28. `gsd-core/templates/requirements.md` [ ] - Pendiente de análisis.
29. `gsd-core/templates/research-project/ARCHITECTURE.md` [ ] - Pendiente de análisis.
30. `gsd-core/templates/research-project/FEATURES.md` [ ] - Pendiente de análisis.
31. `gsd-core/templates/research-project/PITFALLS.md` [ ] - Pendiente de análisis.
32. `gsd-core/templates/research-project/STACK.md` [ ] - Pendiente de análisis.
33. `gsd-core/templates/research-project/SUMMARY.md` [ ] - Pendiente de análisis.
34. `gsd-core/templates/research.md` [ ] - Pendiente de análisis.
35. `gsd-core/templates/retrospective.md` [ ] - Pendiente de análisis.
36. `gsd-core/templates/roadmap.md` [ ] - Pendiente de análisis.
37. `gsd-core/templates/spec.md` [ ] - Pendiente de análisis.
38. `gsd-core/templates/state.md` [ ] - Pendiente de análisis.
39. `gsd-core/templates/summary-complex.md` [ ] - Pendiente de análisis.
40. `gsd-core/templates/summary-minimal.md` [ ] - Pendiente de análisis.
41. `gsd-core/templates/summary-standard.md` [ ] - Pendiente de análisis.
42. `gsd-core/templates/summary.md` [ ] - Pendiente de análisis.
43. `gsd-core/templates/user-profile.md` [ ] - Pendiente de análisis.
44. `gsd-core/templates/user-setup.md` [ ] - Pendiente de análisis.
45. `gsd-core/templates/verification-report.md` [ ] - Pendiente de análisis.
...
* Escaneo secuencial en estricto orden alfabético de las plantillas de la carpeta `gsd-core/templates/` en busca de lógicas y comandos ineficientes de terminal (tipo `grep`, `glob`, `find`, `read`, etc.).

### Fase 2: Escritura y Validación
* Generación de `CODE-REVIEW-GRAPH/templates_mapping.json`.
...
### Verificación Manual
* Validar la validez de `templates_mapping.json` mediante un parser de JSON.
